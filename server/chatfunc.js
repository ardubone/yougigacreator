...
async function getUserFromChat(chatId, messageId) {
  const data = await yougile.Api.get(`/chats/${chatId}/messages/${messageId}`);
  return data.fromUserId; 
}

module.exports = {sendMessage, getMessages, getPrevMessage, createSubtask, getUserFromChat}